...
public class FuncionarioConcursado extends Funcionario{
    ...
    public FuncionarioConcursado(int codigo, double salario, int tempo) {
    ...
    public double calcular_salario(){
        ...
        valorMensal = (getTempo() * 200 + getSalario())+(adicionar*100);
        return valorMensal;
    }
    
    public void exibirConcursado(){
        ...
        if(adicionar == 0){
            ...
            System.out.println("Valor acrescido em virtude dos dependentes: " + adicionar*100);
        }
